  ...
  return (
    <div className="py-20 bg-gradient-t-blue-burst">
      <div className="container mx-auto px-6">
        <RotatingTextStyle>
          <h2 className="py-8 text-5xl font-bold mb-2 text-white">I'm a <ReactRotatingText className="RotatingTextStyle" items={['Developer', 'Designer', 'Researcher', 'Problem-Solver', 'Googling Expert']} /></h2>
        </RotatingTextStyle>
