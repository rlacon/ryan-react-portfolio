  ...
  return (
    <div className="py-20 bg-gradient-t-blue-burst">
      <div className="container mx-auto px-6">
        <RotatingTextStyle>
          <h2 className="py-8 text-5xl font-bold mb-2 text-white">I'm a <ReactRotatingText className="RotatingTextStyle" items={['Developer', 'Researcher', 'Designer', 'Problem-Solver']} /></h2>
        </RotatingTextStyle>
        <button className="bg-white font-bold rounded-full py-4 px-8 shadow-lg uppercase tracking-wider">See my work</button>
        <a href="#" className="underline text-white font-bold py-4 px-8 uppercase tracking-wider">Skills</a>
