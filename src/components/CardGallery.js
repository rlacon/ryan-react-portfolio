...
//         {props.data.map((d, i) => {
//           const { image, title, description, userName, pass, category, githubLink, mainLink } = d;
//           return (
...
//                 </button>
//                 <a href={githubLink} target="_blank" rel="noreferrer noopener" className="text-blue500 hover:text-blue700 underline font-bold py-4 px-8 uppercase tracking-wider">Github</a>
//               </div>
//             </div>
//           );
//         })}
